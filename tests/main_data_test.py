...
def main():
    ...
    coords_list = [
            breath_coords, breath_speed, breath_4_seconds,
            color_picker_open, color_picked, color_picker_ok,
            report_rate_250,
            set_first_dpi, disable_first_dpi,
            apply
    ]
    ...
    with xenon_driver.Driver(0x258a, 0x1007) as driver:
        ...
        th = TestHelper(w)
        thr = threading.Thread(target=th.run_test, args=(coords_list, w.data.main_data, "./test_main_data"))
